...
public class FragmentPreview extends LayoutPreference {
    ...
    public FragmentPreview(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0 /* defStyleAttr */);
    }

    public FragmentPreview(Context context, AttributeSet attrs, int defStyleAttr) {
